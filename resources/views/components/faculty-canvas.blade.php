...
<!-- Off Canvas -->
<!-- Enrollment Canvas -->
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnroll" aria-labelledby="offcanvasTopLabel">
    <div class="offcanvas-header">
      <h5 class="offcanvas-title" id="offcanvasTopLabel"> Subjects Taken </h5>
      <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body">
        <ul id="subsTaken" class="list-group list-group-flush list-group-numbered">
...
<script>
    ...
    const enrollCanvas = document.getElementById('offcanvasEnroll')

    enrollCanvas.addEventListener('show.bs.offcanvas', event => {
        ...
        const subsListEl = document.getElementById('subsTaken');
        //removes the li elements in the offcanvas to replace new ones
        while(subsListEl.firstChild)
            subsListEl.removeChild(subsListEl.firstChild);
        //create li element for each subjects
