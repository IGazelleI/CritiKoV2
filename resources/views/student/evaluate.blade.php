                                    ...
                                    @unless ($subjects->isEmpty())
                                        @foreach ($subjects as $det)
                                                <option value="{{$det->id}}" {{selected() == $det->id? 'selected' : ''}}>
                                                    ({{$det->klase->subject->descriptive_title}}) - {{$det->klase->faculties->first()->fullName(1)}}
                                                </option>
                                        @endforeach
                                    @else
                ...
                <form action="{{route('student.evaluateProcess')}}" method="POST">
                    ...
                    <div class="row rounded border border-dark bg-info d-flex justify-content-center align-items-center my-3">
                        <div class="col-3 text-center p-2">
                            <img src="{{selected() != null? ($subjects->where('id', selected())->first()->klase->faculties->first()->imgPath != null? $subjects->where('id', selected())->first()->klase->faculties->first()->imgPath()
                        ...
                        <div class="col">
                            <div class="row px-5 py-2">
                                <div class="col">
                                    @if($subjects->where('id', selected())->first() != null)
