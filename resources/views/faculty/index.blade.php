                                ...
                                @unless ($b->klases->where('instructor', auth()->user()->id)->first() != null)
                                  @foreach($b->klases->where('instructor', auth()->user()->id) as $klase)
                                    ...
                                    <li class="list-group-item">
                                      <div class="row">
                                        <div class="col-2 text-center" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="{{$klase->subject->descriptive_title}}">
                                          {{$klase->subject->code}}
                                        </div>
                                        <div class="col-3">
                                          {{$klase->schedule}}
                                        ...
                                        <div class="col">
                                          @php
                                              $finished = auth()->user()->faculties->first()->evaluated->where('period_id', $period->id)->where('evaluatee', auth()->useR()->id)->where('subject_id', $klase->subject_id)->count();
                                  ...
                                  @endforeach
                                @else
                                <h3 class="text-center m-4 bg-light p-4 rounded text-uppercase">No subjects handled</h3>
                                @endunless
                              </ul>
                            @endforeach
                          @else
