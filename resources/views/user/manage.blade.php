                        ...
                        <div class="col">
                            ...
                            <div class="row">
                                <div class="col fw-bold">
                                    <a href="{{route('user.assignDean', $det->id, $dean->user_id)}}" class="link-dark"
