                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if($type == 3)
                            <td class="fw-bold">
                                    @if($det->faculties->first()->isDean)
                                        {{$det->faculties->first()->department->name}} Dean
                                    @elseif($det->faculties->first()->department->courses->where('chairman', $det->id)->first() != null)
                                        {{$det->faculties->first()->department->courses->where('chairman', $det->id)->first()->name}} Chairman
                                    @endif
                            </td>
                            @endif
                            <td>
